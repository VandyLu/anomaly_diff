...
DIFFUSION_FLAGS="--diffusion_steps 1000 --noise_schedule linear"
TRAIN_FLAGS="--lr 1e-4 --batch_size 2 --save_interval 2500 --lr_anneal_steps 10000 --ema_rate 0.997  --resume_checkpoint ./256x256_diffusion.pt"
...
export OPENAI_LOGDIR=./work_dirs/uni256_pretrained_4ds_2layer_10k_1gpu
